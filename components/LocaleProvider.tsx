...
type DeepMessages = { [key: string]: string | DeepMessages | DeepMessages[] | string[] };

const MESSAGES: Record<string, DeepMessages> = { en: en as DeepMessages, es: es as DeepMessages };
...
export default function LocaleProvider({ children }: { children: ReactNode }) {
  ...
  const messages = (MESSAGES[locale] || MESSAGES[DEFAULT_LOCALE] || {}) as Record<string, unknown>;
  return (
